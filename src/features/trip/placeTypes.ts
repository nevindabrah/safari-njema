...
const rules: Array<{ type: PlaceType; googleTypes: string[] }> = [
  ...
  { type: 'hospital', googleTypes: ['hospital', 'doctor', 'pharmacy', 'drugstore', 'dental_clinic', 'dentist', 'medical_lab', 'physiotherapist', 'health', 'wellness_center'] },
  { type: 'school', googleTypes: ['school', 'primary_school', 'secondary_school', 'university', 'preschool', 'library'] },
  { type: 'bank', googleTypes: ['bank', 'atm', 'accounting', 'insurance_agency'] },
  { type: 'office', googleTypes: ['embassy', 'consulate', 'post_office', 'police', 'local_government_office', 'city_hall', 'courthouse', 'tourist_information_center'] },
...
export const PLACE_TYPE_INFO: Record<PlaceType, { label: string; about: string }> = {
  ...
  hospital: { label: 'Hospital or clinic', about: 'A hospital, clinic or pharmacy. Medicine is discussed in English, but a greeting and a clear, simple sentence still open the conversation.' },
  school: { label: 'School or university', about: 'A school or university. Greetings and introductions matter here, and the oldest or most senior person is greeted first.' },
  bank: { label: 'Bank', about: 'A bank or cash machine. Numbers are the Swahili that matters most here, along with a greeting at the counter.' },
  office: { label: 'Office or service', about: 'An office, embassy or post office. These places run on queues and paperwork, and patience is noticed.' },
