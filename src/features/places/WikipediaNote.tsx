// Two sentences about a place from Wikipedia with the small credit its licence asks for, or a general note about this kind of place when there is no article.
  ...
  return (
    <div className={className}>
      ...
      {summary ? (
        ...
        <p className="text-[10px] leading-snug text-muted mt-1">A general note. Wikipedia has no article for this exact place.</p>
      )}
    </div>
  )
}
