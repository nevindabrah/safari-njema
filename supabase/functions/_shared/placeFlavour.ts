// Reads Google's detailed place types, which the app already stores for every stop, and turns the most specific one into a noun, a practical note, and extra phrase tags and slots.
...
const FLAVOURS: Array<{ types: string[]; flavour: PlaceFlavour }> = [
