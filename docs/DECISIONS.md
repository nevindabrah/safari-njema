...
**Why.** Lessons for places outside the 51 built-in ones were the weakest part of the app: every restaurant in Kenya got the same lesson. Google's types are free, already stored, and far more precise than our eleven kinds, so this cost nothing and needed no key.
